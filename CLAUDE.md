...
- Category colors are data colors stacked next to each other in the stats chart, and neighbouring categories (in definition order) must stay distinguishable. None may be red, which means expense. That is why 쇼핑 is gold and 미용 lime rather than red and coral. Stack segments get a 1px surface-colored separator.
